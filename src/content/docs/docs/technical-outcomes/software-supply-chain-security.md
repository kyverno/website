...
Additional resources that support this outcome include:

- [Kyverno Sigstore documentation](https://kyverno.io/docs/policy-types/cluster-policy/verify-images/sigstore/)
- [Verify SLSA Provenance policy](https://kyverno.io/policies/other/verify-image-slsa/verify-image-slsa/)
