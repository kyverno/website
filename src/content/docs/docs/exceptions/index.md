...
Kyverno reports controller evaluates the pod as a result of [background scan](/docs/policy-reports/background). It detects that the resource matches the `PolicyException` and Kyverno logs the decision in a `PolicyReport`
