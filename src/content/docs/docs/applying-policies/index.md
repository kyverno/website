...
[Kyverno JSON policies](/docs/subprojects/kyverno-json/) and the new [ValidatingPolicy](/docs/policy-types/cel-policies/validating-policy) and [ImageValidatingPolicy](/docs/policy-types/cel-policies/image-validating-policy) types can be applied to any JSON payload. These policies can be applied via a Golang SDK or web service.
