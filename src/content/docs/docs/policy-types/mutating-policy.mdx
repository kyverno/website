...
Refer to the [API Reference](https://htmlpreview.github.io/?https://github.com/kyverno/kyverno/blob/main/docs/user/crd/kyverno_cel_policies.v1alpha1.html#policies-kyverno-io-v1alpha1-MutatingPolicyEvaluationConfiguration) for details.
...
Refer to the [API Reference](https://htmlpreview.github.io/?https://github.com/kyverno/kyverno/blob/main/docs/user/crd/kyverno_cel_policies.v1alpha1.html#policies-kyverno-io-v1alpha1-WebhookConfiguration) for details.
...
Refer to the [API Reference](https://htmlpreview.github.io/?https://github.com/kyverno/kyverno/blob/main/docs/user/crd/kyverno_cel_policies.v1alpha1.html#policies-kyverno-io-v1alpha1-MutatingPolicyAutogenConfiguration) for details.
