      ...
      cosign:
        ...
        source: # Optional metadata to constrain image source (optional)
          ...
          pullSecrets: # Kubernetes secrets used to access the registry
            ...
            # this notation can be used to reference image pull secret in a different Namespace
            - name: my-namespace/my-registry-secret
...
spec:
  ...
  credentials:
    ...
    secrets:
      - 'my-registry-secret' # Secrets specifies a list of secrets that are provided for credentials.
      - 'my-namespace/my-registry-secret' # this notation can be used to reference image pull secret in a different Namespace
```
