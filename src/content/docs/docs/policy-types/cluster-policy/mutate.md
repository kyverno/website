...
Kyverno supports mutating existing resources already present in the cluster. This is an asynchronous process performed in the background, allowing for retroactive changes or cross-resource synchronization.

For detailed information, examples, and troubleshooting, see the dedicated [Mutate Existing Resources](/docs/policy-types/cluster-policy/mutate-existing) page.
