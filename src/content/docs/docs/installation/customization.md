...
8. `generateMutationEvents`: specifies whether (true/false) to generate events for successful mutations only, without enabling events for other successful policy evaluations. Default is set to "false".
