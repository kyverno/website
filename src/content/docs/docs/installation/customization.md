...
| `allowedResults` (ABR)                  | `pass,fail,error,warn,skip`                         | Comma-separated list of result types for which creating reports is desired. Only results matching the specified values are stored, reducing ETCD pressure in large clusters. Accepted values: `pass`, `fail`, `error`, `warn`, `skip` (1.17+).                                                                                                                                                                                                                                                                                                                                                                                                                  |
