...
- Kyverno CLI: v1.17.0 (commit 3e5e7756) — used to verify local evaluation works (see Optional section below)
- kubectl: v1.35.0
...
See also: Kyverno CEL docs and troubleshooting: https://kyverno.io/docs/writing-policies/validate/validating-policies/cel/
