...
- Kyverno CLI: v1.17.0 (commit 3e5e7756) — used only to confirm the CLI limitation (see Troubleshooting)
- kubectl: v1.35.0
- Kyverno (cluster): v1.17+ (fill in after you validate on a cluster)
