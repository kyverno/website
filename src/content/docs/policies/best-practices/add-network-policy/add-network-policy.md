...
<a href="https://github.com/kyverno/policies/raw/main//best-practices/add-network-policy/add-network-policy.yaml" target="-blank">/best-practices/add-network-policy/add-network-policy.yaml</a>
