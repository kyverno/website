...
<a href="https://github.com/kyverno/policies/raw/main//best-practices/add-ns-quota/add-ns-quota.yaml" target="-blank">/best-practices/add-ns-quota/add-ns-quota.yaml</a>
