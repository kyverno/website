...
<a href="https://github.com/kyverno/policies/raw/main/other/only-trustworthy-registries-set-root/only-trustworthy-registries-set-root.yaml" target="-blank">/other/only-trustworthy-registries-set-root/only-trustworthy-registries-set-root.yaml</a>
