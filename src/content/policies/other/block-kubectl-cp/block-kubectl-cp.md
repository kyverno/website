---
title: 'Block kubectl cp command by Pod Label'
category: validate
severity: medium
type: ClusterPolicy
subjects:
...
<a href="https://github.com/kyverno/policies/raw/main/other/block-kubectl-cp/block-kubectl-cp.yaml" target="-blank">/other/block-kubectl-cp/block-kubectl-cp.yaml</a>
