...
spec:
  ...
  matchConditions:
    - name: check-annotation
      expression: has(object.spec.template.metadata.annotations) &&  "vault.hashicorp.com/agent-inject" in object.spec.template.metadata.annotations && object.spec.template.metadata.annotations["vault.hashicorp.com/agent-inject"] == "true"
  mutations:
