...
metadata:
  ...
  annotations:
    ...
    policies.kyverno.io/description: A Velero Schedule is given in Cron format and must be accurate to ensure operation. This policy validates that the schedule is a valid Cron format.
spec:
  background: true
