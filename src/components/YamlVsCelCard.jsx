...
export const YamlVsCelCard = ({ card, color }) => {
  return (
    <div className="w-[80%] overflow-x-clip sm:w-1/3 lg:w-1/2 bg-dark-50 rounded-2xl sm:h-130">
      <div
        className={twMerge(
      ...
      <p className="whitespace-pre p-6 sm:pr-20 text-left text-[10px] sm:text-sm ">
        {card.content}
      </p>
    </div>
  )
