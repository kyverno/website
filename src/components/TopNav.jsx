    ...
    <nav className='w-full top-10 py-3 backdrop-blur-lg border-b border-neutral-700/80'>
            <div className='container px-4 md:w-full md:px-0 lg:px-4 mx-auto relative text-sm'>
                <div className='flex justify-between items-center'>
                    ...
                    <div className="hidden xl:flex xl:text-lg justify-center space-x-6 
                    items-center">
                        <Button href='https://playground.kyverno.io/' variant='secondary' size='large'>
                             Playground
                        </Button>
                        <Button href='https://kyverno.io/support/' variant='primary' size='large'>
                             Support
                        </Button>
                    </div>
                ...
                {mobileNavOpen && (
                    ...
                    flex-col justify-center items-center space-y-6 lg:hidden mt-3" >
                        ...
                        <div className="xl:hidden flex space-x-2">
                            <Button href='https://playground.kyverno.io/' variant='secondary' size='medium'>
                             Playground
                            </Button>
                            <Button href='https://kyverno.io/support/' variant='primary' size='medium'>
                             Support
                            </Button>
                        </div>
                        </div>
