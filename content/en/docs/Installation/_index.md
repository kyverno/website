...
8. `dumpPayload`: toggles Debug mode. When Debug mode is enabled, AdmissionReview payload is logged. Additionally, resources of kind *secrets* are redacted. Default is `false`.
