...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/release-1.6//openshift/validate-routes/check-routes.yaml" target="-blank">/openshift/validate-routes/check-routes.yaml</a>
