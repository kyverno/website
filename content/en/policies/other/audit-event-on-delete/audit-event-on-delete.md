...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/audit-event-on-delete/audit-event-on-delete.yaml" target="-blank">/other/audit-event-on-delete/audit-event-on-delete.yaml</a>
