...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/release-1.6//other/add-image-as-env-var/add-image-as-env-var.yaml" target="-blank">/other/add-image-as-env-var/add-image-as-env-var.yaml</a>
