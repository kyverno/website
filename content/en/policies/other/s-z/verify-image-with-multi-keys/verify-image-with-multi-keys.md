...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/s-z/verify-image-with-multi-keys/verify-image-with-multi-keys.yaml" target="-blank">/other/s-z/verify-image-with-multi-keys/verify-image-with-multi-keys.yaml</a>
