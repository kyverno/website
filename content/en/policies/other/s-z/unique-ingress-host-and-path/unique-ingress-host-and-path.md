...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/s-z/unique-ingress-host-and-path/unique-ingress-host-and-path.yaml" target="-blank">/other/s-z/unique-ingress-host-and-path/unique-ingress-host-and-path.yaml</a>
