...
policyType: "validate"
description: >
    NetworkPolicy resources are used to control pod-to-pod communication and are good practices to ensure only authorized pods can send/receive traffic. This sample policy checks incoming Deployments to ensure they have a matching, preexisting NetworkPolicy.
---

## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/require_netpol.yaml" target="-blank">/other/require_netpol.yaml</a>
