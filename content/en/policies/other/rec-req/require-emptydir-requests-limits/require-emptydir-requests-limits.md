...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/rec-req/require-emptydir-requests-limits/require-emptydir-requests-limits.yaml" target="-blank">/other/rec-req/require-emptydir-requests-limits/require-emptydir-requests-limits.yaml</a>
