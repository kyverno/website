...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/rec-req/require-unique-uid-per-workload/require-unique-uid-per-workload.yaml" target="-blank">/other/rec-req/require-unique-uid-per-workload/require-unique-uid-per-workload.yaml</a>
