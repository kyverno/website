...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/rec-req/require-base-image/require-base-image.yaml" target="-blank">/other/rec-req/require-base-image/require-base-image.yaml</a>
