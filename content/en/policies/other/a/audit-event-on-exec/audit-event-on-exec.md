...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/a/audit-event-on-exec/audit-event-on-exec.yaml" target="-blank">/other/a/audit-event-on-exec/audit-event-on-exec.yaml</a>
...
metadata:
  ...
  annotations:
    ...
    policies.kyverno.io/description: >-
      ...
      custom designed to your needs. This policy generates an Event on a Pod when an exec
      has been made to it. It lists the userInfo of the actor performing the exec along
