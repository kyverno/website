...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/b-d/check-nvidia-gpu/check-nvidia-gpu.yaml" target="-blank">/other/b-d/check-nvidia-gpu/check-nvidia-gpu.yaml</a>
