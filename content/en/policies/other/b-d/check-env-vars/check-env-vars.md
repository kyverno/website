...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/b-d/check-env-vars/check-env-vars.yaml" target="-blank">/other/b-d/check-env-vars/check-env-vars.yaml</a>
