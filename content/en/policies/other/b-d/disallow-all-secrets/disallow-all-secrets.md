...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/b-d/disallow-all-secrets/disallow-all-secrets.yaml" target="-blank">/other/b-d/disallow-all-secrets/disallow-all-secrets.yaml</a>
