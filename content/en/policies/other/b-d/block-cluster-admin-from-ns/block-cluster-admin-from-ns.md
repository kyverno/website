...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/b-d/block-cluster-admin-from-ns/block-cluster-admin-from-ns.yaml" target="-blank">/other/b-d/block-cluster-admin-from-ns/block-cluster-admin-from-ns.yaml</a>
