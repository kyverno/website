...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//other/m-q/only-trustworthy-registries-set-root/only-trustworthy-registries-set-root.yaml" target="-blank">/other/m-q/only-trustworthy-registries-set-root/only-trustworthy-registries-set-root.yaml</a>
