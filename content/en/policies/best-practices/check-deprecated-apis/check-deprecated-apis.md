...
## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//best-practices/check-deprecated-apis/check-deprecated-apis.yaml" target="-blank">/best-practices/check-deprecated-apis/check-deprecated-apis.yaml</a>
...
spec:
  ...
  - name: validate-v1-32-removals
    ...
    validate:
      message: >-
        {{ request.object.apiVersion }}/{{ request.object.kind }} is deprecated and will be removed in v1.32.
        See: https://kubernetes.io/docs/reference/using-api/deprecation-guide/
      deny: {}
