...
policyType: "validate"
description: >
    This policy mitigates CVE-2021-25746 by restricting `metadata.annotations` to safe values. See: https://github.com/kubernetes/ingress-nginx/blame/main/internal/ingress/inspector/rules.go. This issue has been fixed in NGINX Ingress v1.2.0. For NGINX Ingress ersion 1.0.5+ the  "annotation-value-word-blocklist" configuration setting is also recommended.  Please refer to the CVE for details. 
---

## Policy Definition
<a href="https://github.com/kyverno/policies/raw/main//best-practices/nginx_annotation_checks/restrict-annotations.yaml" target="-blank">/best-practices/nginx_annotation_checks/restrict-annotations.yaml</a>
...
metadata:
  ...
  annotations:
    ...
    policies.kyverno.io/description: >-
      ...
      This issue has been fixed in NGINX Ingress v1.2.0. For NGINX Ingress ersion 1.0.5+ the 
