...
## Policy Definition
<a href="https://github.com/JimBugwadia/kyverno-policies/raw/fix_annotations//pod-security/baseline/disallow-host-process/disallow-host-process.yaml" target="-blank">/pod-security/baseline/disallow-host-process/disallow-host-process.yaml</a>
